...
#import "SDMailBoxTextView.h"

@interface SDMailBoxTextView ()<UITextFieldDelegate>
...
///配置
@property (nonatomic, strong) SDMailBoxTextViewConfigure *configure;

@end


@implementation SDMailBoxTextViewConfigure

+ (instancetype)defaultConfigure {
    SDMailBoxTextViewConfigure *configure = [[SDMailBoxTextViewConfigure alloc] init];
...
@implementation SDMailBoxTextView
...
- (void)initUI {
    ...
    self.textField.placeholder = self.configure.placeholder;
...
- (SDMailBoxTextViewConfigure *) configure {
    if (_configure == nil) {
        _configure = [SDMailBoxTextViewConfigure defaultConfigure];
    }
    return _configure;
}
